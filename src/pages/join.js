    ...
    <Layout>
      ...
      <div className="about-container">
        <div className="about-content">
          ...
          <p>
            Join us for weekly lessons on InfoSec and CySec fundamentals as well
            as talks and networking events with industry professionals.
          </p>
          <h1>How To Join</h1>
          <p>
            ...
            <a href="https://discord.gg/sUAJ9b3">Discord server</a> where we
            discuss challenges and post details about upcoming events.
          </p>
          <h1>Workshops</h1>
          <p>
            ...
            While the university is not offering face-to-face classes, all
            events will be online. Workshops are held on <b>Thursdays</b>{" "}
            evenings via Discord (see the <Link to="/events">events page</Link>{" "}
            or our <a href="https://facebook.com/uomisc">Facebook page</a> for
            more details about workshops and other events). These workshops are
            aimed at giving you essential knowledge and letting you improve your
            practical skills with custom designed CTF-style challenges. We cover
          ...
          <h1>Constitution</h1>
          <p>
            The club's constitution can be found{" "}
            <a href="/misc-constitution-2018aug.pdf">here</a>.
          </p>
        </div>
      </div>
    </Layout>
