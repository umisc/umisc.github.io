          ...
          <div className="sponsors-container">
            <div className="sponsors-logos">
              <a href="https://www.atlassian.com/">
                <img src={atlassian_logo} className="atlassian-logo" />
              </a>
            </div>
            <div className="sponsors-logos">
            ...
            <div className="sponsors-logos">
              <a href="https://dronesec.com/">
                <img src={dronesec_logo} className="dronesec-logo" />
              </a>
            </div>
            <div className="sponsors-logos">
              <a href="https://www.kaspersky.com.au/">
                <img src={kaspersky_logo} className="kaspersky-logo" />
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="sponsors-container">
            <div className="sponsors-logos">
              <a href="https://pentesterlab.com/">
                <img src={pentesterlab_logo} className="pentesterlab-logo" />
              </a>
            </div>
            <div className="sponsors-logos">
              <a href="https://www.commbank.com.au/">
                <img src={commbank_logo} className="commbank-logo" />
              </a>
            </div>
            <div className="sponsors-logos">
              <a href="https://pure.security/">
                <img src={puresecurity_logo} className="puresecurity-logo" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="sponsors-container">
          <div className="sponsors-logos">
            <a href="https://www.optiver.com/">
              <img src={optiver_logo} className="optiver-logo" />
            </a>
          </div>
          <div className="sponsors-logos">
            <a href="https://www.accenture.com/au-en">
              <img src={accenture_logo} className="accenture-logo" />
            </a>
          </div>
        </div>
      </div>
